...
public class courseDAO {
	...
	public int createSchedule(createScheduleVO vo) {
	...
	public int createDaily(createScheduleVO vo) {
		SqlSession session = sqlSessionFactory.openSession(true);//auto commit
	...
	public List<createScheduleVO> importMyCourse(int mt_idx) {
		// TODO Auto-generated method stub
		List<createScheduleVO> dailyCourseList = null;
		SqlSession sqlSession = sqlSessionFactory.openSession(true);
